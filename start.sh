...
wget https://raw.githubusercontent.com/SIRCO-TEAMS/pi/refs/heads/main/nginx.sh
wget https://raw.githubusercontent.com/SIRCO-TEAMS/pi/refs/heads/main/node_pispot.sh
